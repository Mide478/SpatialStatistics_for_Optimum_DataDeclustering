...
```{r}
 setwd("~/Documents/UT/Research/PyCharm/SSADC/Warm Up To be Transferred/Current Scripts/SSADC Example Case")
```
...
for(i in (1:1)){      # 1:max nos of realizations made i.e. the dataset
  x<-data[2*i-1]
  y<-data[2*i]
...
write.csv(df_k,'cellsizes_Ripley_Example.csv')
